    ...
    <section className="relative overflow-hidden bg-white px-6 py-16 sm:px-25 lg:flex lg:h-170 lg:items-center lg:py-0">
      ...
      <div className="relative mx-auto flex max-w-300 flex-col gap-2">
        <div className="flex max-w-150 flex-col items-start gap-0">
          ...
          <p className="text-lg font-medium leading-normal text-brand-gray sm:text-[19px]">
          ...
          <div className="flex flex-wrap items-center gap-5 mt-5">
            ...
            <BookConsultationButton className="flex h-15 items-center rounded-full border-2 border-black bg-black px-7.5 text-lg font-medium text-white transition-colors duration-300 hover:border-2 hover:border-[#314ce2] hover:bg-transparent hover:text-[#314ce2] hover:select-none">
              Book a Consultation
