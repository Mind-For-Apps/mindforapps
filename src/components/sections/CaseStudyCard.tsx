...
export function CaseStudyCard({
  ...
  return (
    <Link
      ...
      className="flex w-full flex-col overflow-hidden lg:flex-row lg:h-180 max-w-400">
      <div className="
      flex flex-col gap-6 overflow-y-auto bg-white p-8 sm:p-12.5 lg:h-full lg:flex-1 h-200 min-[883px]:max-[1023px]:h-160 min-[530px]:max-[882px]:h-170 min-[1100px]:max-[1180px]:p-3! min-[1024px]:max-[1101px]:p-2!">
        {slide.logoUrl && (
