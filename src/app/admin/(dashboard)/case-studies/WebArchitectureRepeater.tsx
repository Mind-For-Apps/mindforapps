...
type WebArchitectureItem = { label: string; iconUrl: string };

export function WebArchitectureRepeater({
  defaultValues,
  pathPrefix,
}: {
  defaultValues?: WebArchitectureItem[];
  pathPrefix: string;
}) {
  const [items, setItems] = useState<WebArchitectureItem[]>(
  ...
  return (
    <div className="flex flex-col gap-1.5">
      <label className="text-sm font-medium text-black">What Was Built</label>
