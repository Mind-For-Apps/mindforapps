      ...
      <main className="flex flex-1 flex-col pb-16">
        ...
        <section id="request" className="bg-black px-6 py-16 sm:px-25">
          <div className="mx-auto grid w-full max-w-300 grid-cols-1 overflow-hidden rounded-[30px] shadow-[0px_20px_60px_0px_rgba(0,0,0,0.4)] lg:grid-cols-2">
            ...
            <form className="flex flex-col gap-6 bg-white p-10 sm:p-14">
              <div className="flex flex-col gap-1">
                <label
                  htmlFor="website-url"
              ...
              <button
                type="button"
                className="group mt-4 flex h-14 items-center justify-center gap-2 rounded-full border-2 border-transparent bg-black px-8 text-lg font-semibold text-white transition-colors hover:border-[#314cde] hover:bg-transparent hover:text-[#314cde]"
              >
